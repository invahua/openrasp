...
PHP_MINIT_FUNCTION(openrasp)
{
    ...
    {
        openrasp_error(E_WARNING, CONFIG_ERROR, _("openrasp.root_dir should be configured correctly in php.ini (not null, not root path, not relative path and permissible), continue without security protection"));
        return SUCCESS;
    }
